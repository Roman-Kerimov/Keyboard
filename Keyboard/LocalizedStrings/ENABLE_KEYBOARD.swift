...
struct ENABLE_KEYBOARD: LocalizedString {
    private static let productName = Bundle.main.productName
    ...
    static var en:        String {return "Enable \(productName)"}
    ...
    static var ru:        String {return "Включить \(productName)"}
