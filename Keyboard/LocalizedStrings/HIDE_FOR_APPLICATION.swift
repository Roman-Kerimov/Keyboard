...
struct HIDE_FOR_APPLICATION: LocalizedString {
    ...
    static var en:        String {return "Hide for \(NSWorkspace.shared.frontmostApplicationName)"}
    ...
    static var ru:        String {return "Скрыть для \(NSWorkspace.shared.frontmostApplicationName)"}
