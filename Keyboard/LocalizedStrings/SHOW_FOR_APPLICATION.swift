...
struct SHOW_FOR_APPLICATION: LocalizedString {
    ...
    static var en:        String {return "Show for \(NSWorkspace.shared.frontmostApplicationName)"}
    ...
    static var ru:        String {return "Показать для \(NSWorkspace.shared.frontmostApplicationName)"}
