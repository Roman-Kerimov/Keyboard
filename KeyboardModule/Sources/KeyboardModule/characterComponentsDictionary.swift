...
let characterComponentsDictionaryMaxUnicodeScalarCount: Int = characterComponentsDictionary.keys
    .map {$0.decomposedStringWithCanonicalMapping.unicodeScalars.count}
    .max() ?? 0
